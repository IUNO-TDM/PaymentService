...
import iuno.tdm.paymentservice.init.WalletInitializer;
...
public class Bitcoin implements WalletCoinsReceivedEventListener, WalletChangeEventListener, BitcoinInvoiceCallbackInterface {
    ...
    public void start(ServletContext sctx) { // TODO: this method must be called once only!
        ...
        String predefinedSeed = System.getProperty("walletSeed");
        String passphrase = System.getProperty("walletPassphrase");
        long creationtime = Long.parseLong(System.getProperty("walletCreationTime"));
        wallet = WalletInitializer.initializeWallet(PREFIX, context, automaticallyRecoverBrokenWallet, predefinedSeed, passphrase, creationtime);
